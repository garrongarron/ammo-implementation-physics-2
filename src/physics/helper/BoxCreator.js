...
class BoxCreator {
    ...
    createBox() {
        ...
        this.object3d.scale.set(this.params.scale.x, this.params.scale.y, this.params.scale.z);
    ...
    #getShape() {
        let colShape = new Ammo.btBoxShape( new Ammo.btVector3( this.params.scale.x * 0.5, this.params.scale.y * 0.5, this.params.scale.z * 0.5 ) );
